...
| :--- | :--- | :--- |
| `[NOM_PLUGIN]` | Nom du Plugin | `Candidature Section Échecs Collège Briand` |
| `[SLUG]` | Slug / Textdomain | `candidature-echecs-briand` |
| `[SLUG_MAJ]` | Slug en Majuscule | `CEB` (pour les constantes) |
| `[PREFIX]` | Prefix PHP (Fonctions) | `ceb_` |
| `[NAMESPACE]` | Namespace PHP | `CEB\` |
| `[DB_SLUG]` | Suffixe Table SQL | `ceb_` |
| `[DESC]` | Description | `Gestion des candidatures pour la section sportive échecs` |
